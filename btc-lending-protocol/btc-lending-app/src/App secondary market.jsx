...
function App() {
  ...
  // Mock marketplace data (will be replaced with real contract calls)
  const [listedPositions, setListedPositions] = useState([
    { 
      ...
      borrowAmount: 50000,
      maxRepayment: 75000,
      loanDuration: 3312, // 23 days in blocks
      maturityBlock: currentBlock + 3312,
      askingPrice: 53000,
      offers: [
        { id: 1, buyer: 'ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG', amount: 52000, status: 'pending' },
        { id: 2, buyer: 'ST2JHG321N6TXY0FY3XYT1XY9Y3XYZ1XY0FY3XYT', amount: 51500, status: 'pending' }
      ]
    },
    { 
      id: 1, 
      ...
      borrowAmount: 40000,
      maxRepayment: 48000,
      loanDuration: 4176, // 29 days in blocks
      maturityBlock: currentBlock + 4176,
      askingPrice: null, // Accepting offers only
      offers: []
    }
  ]);
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr>
                    ...
                    <SortHeader label="Max. APY" sortKey="maxAPY" />
                  ...
                  {myOffers.map((offer, index) => (
                    <tr key={index} style={{ borderBottom: '1px solid #334155' }}>
                      ...
                      <td style={{ padding: '12px 8px', textAlign: 'center' }}>
                        <button
                          onClick={() => {
                            setMyOffers(myOffers.filter((_, i) => i !== index));
                            showMessage('Offer cancelled', 'success');
                          }}
                          style={{
                            padding: '6px 12px',
                            background: '#ef4444',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <button
                  onClick={() => {
                    showMessage('Position listed for sale! (Demo - contract integration needed)', 'success');
                    setShowListModal(false);
                    setListingPrice('');
                    setSelectedPosition(null);
                  }}
                  ...
                  onClick={() => {
                    if (offerAmount) {
                      setMyOffers([...myOffers, {
                        loanId: selectedPosition.id,
                        type: selectedPosition.type,
                        offerAmount: parseFloat(offerAmount),
                        askingPrice: selectedPosition.askingPrice,
                        status: 'pending',
                        counterOffer: null
                      }]);
                      showMessage('Offer submitted! (Demo - contract integration needed)', 'success');
                      setShowOfferModal(false);
                      setOfferAmount('');
                      setSelectedPosition(null);
                    }
