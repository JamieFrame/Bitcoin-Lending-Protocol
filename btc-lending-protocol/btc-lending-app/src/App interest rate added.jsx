                ...
                {openAuctions.filter(auction => {
                  ...
                  <div key={auction.id} style={{ background: '#0f172a', padding: '16px', borderRadius: '6px', marginBottom: '12px', border: '1px solid #334155' }}>
                    ...
                    <div style={{ fontSize: '14px', color: '#cbd5e1', display: 'grid', gap: '4px' }}>
                      ...
                      <div>Max Interest: <span style={{ color: '#ef4444' }}>{((auction.maxRepayment - auction.borrowAmount) / auction.borrowAmount * 100).toFixed(2)}%</span></div>
                      {auction.isAuction && (
                      ...
                      {auction.isAuction && auction.currentBid && (
                        <div>Current Interest: <span style={{ color: '#3b82f6' }}>{((auction.currentBid - auction.borrowAmount) / auction.borrowAmount * 100).toFixed(2)}%</span></div>
                      )}
                        ...
                        <div style={{ fontSize: '14px', color: '#cbd5e1', display: 'grid', gap: '4px' }}>
                          ...
                          {auction.currentBid ? (
                            <>
                              ...
                              <div>Final Interest: <span style={{ color: '#3b82f6' }}>{((auction.currentBid - auction.borrowAmount) / auction.borrowAmount * 100).toFixed(2)}%</span></div>
                            </>
                          ) : (
                  ...
                  {failedAuctions.map((loan) => (
                    <div key={loan.id} style={{ background: '#0f172a', padding: '16px', borderRadius: '6px', marginBottom: '12px', border: '1px solid #991b1b' }}>
                      ...
                      <div style={{ fontSize: '14px', color: '#cbd5e1', display: 'grid', gap: '4px' }}>
                        ...
                        <div>Interest Rate: <span style={{ color: '#a78bfa' }}>{((loan.maxRepayment - loan.borrowAmount) / loan.borrowAmount * 100).toFixed(2)}%</span></div>
                        {loan.currentBid && (
