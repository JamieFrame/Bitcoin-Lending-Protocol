              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Max. Interest</th>
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Current Bid (USDT)</th>
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Current Interest</th>
                    <SortHeader label="Duration" sortKey="loanDuration" />
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Time Remaining</th>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr>
                    ...
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Interest Rate</th>
                    <SortHeader label="Duration" sortKey="loanDuration" />
                    <th style={{ padding: '12px 8px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#94a3b8', borderBottom: '2px solid #334155', whiteSpace: 'nowrap' }}>Time Remaining</th>
