;; Bitcoin-USDT Lending Protocol v27 (MINIMAL UPDATE)
;; Descending auction system with tradeable NFT positions
;; 
;; CHANGES FROM V26:
;; - Added 2 public functions: transfer-lender-position, transfer-borrower-position
;; - Added 2 read-only functions: is-lender-owner, is-borrower-owner
;; - Added 3 constants: ERR_UNAUTHORIZED, ERR_NOT_POSITION_OWNER, marketplace-contract variable
;; - Added 1 admin function: set-marketplace-contract
;; Total additions: ~60 lines of code
;;
;; ALL OTHER FUNCTIONALITY IDENTICAL TO V26
