;; Bitcoin-USDT Lending Protocol v25
...
;; FIX v24: Uses transfer-from (requires authorization via set-authorized-contract)
;; FIX v25: Uses fixed token contracts (v21) with contract-caller instead of tx-sender
;; NOTE: Token contracts now properly check contract-caller for authorization
